...
if isempty(Ventana) || ~ishandle(Ventana) || ~isscalar(Ventana)
    ...
    for i=1:size(BotonesEnBarra,1)
        if ...
                ...
                ~strcmp(BotonesEnBarra{i},'Insert Colorbar') && ...
                ~strcmp(BotonesEnBarra{i},'Link Plot') && ...
...
C_HA0           = Datos_s.C_HA0;
C_A0            = Datos_s.C_A0;
C_H30init       = Datos_s.C_H3Oinicial;
C_OHinit        = Kw/Datos_s.C_H3Oinicial;
V0              = Datos_s.V0;
Vr              = Datos_s.Vr;
...
Polinomio       = ...
    [...
    +1,...
    +(1-1/Ka*(C_Ainit-C_H30init+C_OHinit)),...
    -(Kw/Ka^2-1/Ka*(C_HAinit+C_H30init-C_OHinit)),...
    -Kw/Ka^2
    ];
...
b               = ...
    ...
    +(C_HAinit+C_Ainit).*Ka.*C_H3O_Barrido./(Ka+C_H3O_Barrido) ...
    );
