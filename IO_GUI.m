...
if isempty(outputWindow) || ~ishandle(outputWindow) || ~isscalar(outputWindow)
    outputWindow = figure('Menu','none','Toolbar','figure',...
        'Color',[255,255,255]/255,'Name','Equilibrium Solution',...
    ...
    Tabla_Entrada   = uitable('Parent',Panel2,...
        ...
        'RowName',{},...
        'ColumnName',{'i','COMPONENTE','VALOR','UNIDADES'},...
        'ColumnWidth',{ 20 85 50 'auto' },...
    ...
    set(Tabla_Entrada,'CellEditCallback',@inputCellEdit);
...
function inputCellEdit(hObject, eventdata, handles,varargin)
